    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Start building your knowledge base today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {nameError && (
                <p className="mt-1 text-sm text-red-600">{nameErrorMsg}</p>
              )}
            </div>
            ...
            <div>
              ...
              {emailError && (
                <p className="mt-1 text-sm text-red-600">{emailErrorMsg}</p>
              )}
            </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 border-2 border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all"
            >
